...
public class PartService {
    ...
    public Part registration(@Valid DataPart dataPart) {
        return partRepository.save(new Part(dataPart));
    }
    ...
    public DataAllPart update(Long id, DataPart part) {
        return this.partRepository.findById(id)
                .map(existingPart -> {
                    existingPart.update(part);
